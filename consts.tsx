...
// Fix: Removed top-level await by exporting file names instead of fetched URLs.
// This prevents module loading issues that were causing type inference failures in other components.
